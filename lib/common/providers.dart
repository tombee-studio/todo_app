...
import 'package:todo_app/ui/project/view_model/repository/project_screen_app_repository.dart';
...
final projectScreenRepositoryProvider =
    RepositoryProvider<ProjectScreenRepository>(
        () => ProjectScreenAppRepository());
